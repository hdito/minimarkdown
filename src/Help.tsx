...
export const Help = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-800 text-black dark:text-gray-100">
      <header className="flex px-4 py-2 items-baseline gap-4 mb-4">
      ...
      <main>
        <section className="px-4">
          <p className="max-w-prose mb-4">{t('description')}</p>
        </section>
        <section className="pb-4 grid grid-cols-[auto_auto] sm:grid-cols-[minmax(auto,_40ch)_1fr]">
          ...
          <em className="px-4 py-1 bg-gray-100 dark:bg-gray-700">
            {t('italic')}
          </em>
          <p className="px-4 py-1">
            **{t('bold')}** {t('or')} __{t('bold')}__
          </p>
          <strong className="px-4 py-1">{t('bold')}</strong>
          <h3 className="px-4 py-1 mt-6 text-xl font-bold col-span-2">Lists</h3>
          <p className="px-4 py-1 bg-gray-100 dark:bg-gray-700">
            * {t('item')} 1 <br />* {t('item')} 2
          </p>
